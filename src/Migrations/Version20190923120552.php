 ...
 */
final class Version20190923120552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post ADD title VARCHAR(30) NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post DROP title, CHANGE user_id user_id INT DEFAULT NULL');
    }
}
